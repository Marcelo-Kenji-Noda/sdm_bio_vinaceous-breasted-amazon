...
MODELS = {
    "pipeline_random_forest_class": RandomForestClassifier(),
    "pipeline_extra_tree_class": ExtraTreesClassifier(),
    "pipeline_ada_class": AdaBoostClassifier(),
    "pipeline_bagging_class": BaggingClassifier(),
    "pipeline_gbooster": GradientBoostingClassifier(),
    "pipeline_xgb_class": XGBClassifier(),
    "pipeline_lightgbm": LGBMClassifier(),
    "pipeline_maxent": LogisticRegression(),
}
...
if __name__ == "__main__":
    ...
    for model_name in config["models_pipeline"]["selected_models"]:
        ...
        _, m = evaluate_clf(
            ...
            name=model_name,
            filepath=filepath,
            k=config["models_pipeline"]["k"],
            test_size=config["models_pipeline"]["test_size"],
            scoring=config["models_pipeline"]["scoring"],
        ...
        try:
            ...
            print(m)
    print(f"[SUCESS] RAN MODELS: {config['models_pipeline']['selected_models']}")
